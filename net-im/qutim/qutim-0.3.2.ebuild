...
SRC_URI="http://qutim.org/dwnl/68/${P}.tar.xz"

LICENSE="GPL-3"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="aspell awn ayatana crypt dbus debug doc histman hunspell irc jabber kde kinetic mrim
	multimedia oscar otr phonon purple qml sdl +ssl telepathy vkontakte webkit +xscreensaver +artwork"
...
src_install() {
		if use artwork; then
		  dodir /usr/share/apps/qutim/sounds
		  cp -a ${S}/artwork/sounds/* ${D}/usr/share/apps/qutim/sounds
		fi
